 ...
 * Generated manually from migrations 001–012.
...
export type Database = {
  public: {
    Tables: {
      ...
      vendors: TableDef<VendorRow, WithOptional<VendorRow, 'id' | 'rfc' | 'email' | 'clabe' | 'is_active' | 'rfc_validated' | 'clabe_verified' | 'clabe_holder_name' | 'bank_name' | 'efos_status' | 'odoo_id' | 'synced_at' | 'phone' | 'created_at' | 'updated_at'>>;
      customers: TableDef<CustomerRow, WithOptional<CustomerRow, 'id' | 'rfc' | 'email' | 'clabe' | 'is_active' | 'fintoc_clabe' | 'fintoc_account_id' | 'odoo_id' | 'phone' | 'created_at' | 'updated_at'>>;
      expenses: TableDef<ExpenseRow, WithOptional<ExpenseRow, 'id' | 'employee_name' | 'employee_email' | 'category' | 'description' | 'currency' | 'status' | 'xml_url' | 'rejected_reason' | 'approved_by' | 'created_by' | 'created_at'>>;
      ...
      notifications: TableDef<NotificationRow, WithOptional<NotificationRow, 'id' | 'user_id' | 'notification_type' | 'event_type' | 'entity_type' | 'entity_id' | 'title' | 'message' | 'is_read' | 'read' | 'created_at'>>;
      ...
      bank_movements: TableDef<BankMovementRow, WithOptional<BankMovementRow, 'id' | 'fintoc_id' | 'fintoc_movement_id' | 'account_id' | 'currency' | 'description' | 'post_date' | 'date' | 'type' | 'reference_id' | 'sender_account' | 'balance_after' | 'reconciled' | 'reconciled_payment_id' | 'created_at'>>;
      ...
      audit_log: TableDef<AuditLogRow, WithOptional<AuditLogRow, 'id' | 'changes' | 'metadata' | 'created_at'>>;
      ...
      cfdi_documents: TableDef<CfdiDocumentRow, WithOptional<CfdiDocumentRow, 'id' | 'uuid' | 'tipo_comprobante' | 'rfc_emisor' | 'nombre_emisor' | 'rfc_receptor' | 'total' | 'sat_status' | 'fecha_emision'>>;
    };
    Views: {};
